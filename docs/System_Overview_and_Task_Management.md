...
| **WF2 - Face Registration** | `faces`               | Sinh viên/nhân viên tải ảnh lên. Hệ thống gọi Rekognition để `IndexFaces` và lưu metadata vào DynamoDB.                               | HTTP Request ➡️ Publish `FaceRegistered`                                                                  |
